...
export MINDSTONE_AGENT_HANDOFF_DIR="${MINDSTONE_AGENT_HANDOFF_DIR:-${MINDSTONE_AGENT_DATA_DIR}/handoffs}"
export MINDSTONE_AGENT_MEMORY_DIR="${MINDSTONE_AGENT_MEMORY_DIR:-${MINDSTONE_AGENT_DATA_DIR}/memory}"
export MINDSTONE_AGENT_JOURNAL_DIR="${MINDSTONE_AGENT_JOURNAL_DIR:-${MINDSTONE_AGENT_DATA_DIR}/journals}"
export MINDSTONE_AGENT_LOG_PATH="${MINDSTONE_AGENT_LOG_PATH:-${MINDSTONE_AGENT_DATA_DIR}/LOG.md}"
export MINDSTONE_AGENT_MEMORY_INDEX_PATH="${MINDSTONE_AGENT_MEMORY_INDEX_PATH:-${MINDSTONE_AGENT_MEMORY_DIR}/MEMORY.md}"
...
mkdir -p \
  ...
  "${MINDSTONE_AGENT_HANDOFF_DIR}" \
  "${MINDSTONE_AGENT_MEMORY_DIR}" \
  "${MINDSTONE_AGENT_JOURNAL_DIR}" \
  "$(dirname "${MINDSTONE_AGENT_LOG_PATH}")" \
  "$(dirname "${MINDSTONE_AGENT_MEMORY_INDEX_PATH}")"
