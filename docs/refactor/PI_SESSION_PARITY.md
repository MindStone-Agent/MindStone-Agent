...
- deeper session-file/tree repair beyond the current lockfile/stale-lock, malformed-tail safety layer, and in-memory resume cap
- session-store indirection beyond direct deterministic session-key mapping
