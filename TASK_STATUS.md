...
- [x] Add Core `AgentRunner` boundary and wire native chat/Gateway route execution through the default provider-route runner, including run context and runner diagnostics.
