...
- [x] Add Pi adapter setup/status/context/gateway/channels/recall commands with smoke coverage: `/mindstone-setup`, `/mindstone-config`, `/mindstone-status`, `/mindstone-agent-status`, `/mindstone-context`, `/mindstone-gateway-status`, `/mindstone-channels`, `/mindstone-recall-status`, and `/mindstone-recall-search <query> [--limit N]`.
